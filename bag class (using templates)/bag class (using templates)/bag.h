// FILE: bag.h (part of the namespace template_adnan)
...
#ifndef TEMPLATE_BAG_H
#define TEMPLATE_BAG_H
#include <cstdlib>   // Provides NULL and size_t and NULL
#include "template_node.h"   // Provides node class
