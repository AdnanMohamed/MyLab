// FILE: template_node.h (part of the namespace template_node_adnan)
...
//   Precondition: head_ptr is the pointer to the head of a linked-list.
//   Postcondition: The old linked list does not have duplicate entries.
//
//  template<class Item>
//  void list_reverse(node<Item>*& head_ptr)
//   Precondition: head_ptr is the pointer to the head of a linked-list.
//   Postcondition: head_ptr points to the head of the reversed list.
//   So the first node in the old list became the last vise versa.
//
//  template<class Item>
//  node<Item>* merge_sorted_list(node<Item>* head_ptr1, node<Item>* head_ptr2)
//   Precondition: head_ptr1, head_ptr2 are pointers to a sorted 2 linked-lists,
//   where elements are sorted in increasing order with no duplicates in each list.
//   Postcondition: Returns the head_ptr to the new linked list which contains elements
//   of both lists sorted in increasing order (using < optor) and no duplicates.
//
...
#include "template_node.template"
#endif
