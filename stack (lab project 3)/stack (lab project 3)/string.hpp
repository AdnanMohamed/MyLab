...
public:
    ...
    std::vector<String> split(char) const; // returns a vector of strings depending on the split character
...
String  operator+       (const String&, const char[]); //@AM
String  operator+       (char, const String&);
String  operator+       (const String&, char); // @AM
String& operator+=      (String&, char); //@AM
String& operator+=      (String&, const char[]); //@AM
