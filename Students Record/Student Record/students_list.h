...
// The class Node and the helping functions are within namespace node_student_adnan
...
namespace node_student_adnan
{
    ...
    public:
        // TYPEDEF
        typedef student_adnan::Student value_type;
        ...
        value_type& actual_data() { return data_field; }
